# ATTENTION
- (2022/07/23 23:00) 画像が格納されている beatsaver.com のサーバー(eu.cdn.beatsaver.com) の証明書有効期限が切れていて[Beatmap Online]画面などで  
  譜面のカバー画像を表示できないようです。beatsaver.com 側で対処されるまでお待ちください。
